...
print ("You want to visit", country_to_visit)
...
print ("The currency exchange rate is", exchange_rate)
# Print out a sentence with the value of satisfied
print ("Are you statisfied with your vacation plans", satisfied)